...
#
# Usage:
#   Rscript tools/install_dependencies.R            # Required packages only
#   Rscript tools/install_dependencies.R --all       # Required + optional
#
# =============================================================================
...
OPTIONAL <- c(
  ...
  'future',      # Parallel mode backend (src/core/parallel.R, --parallel)
