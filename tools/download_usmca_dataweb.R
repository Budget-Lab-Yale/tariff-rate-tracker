...
#
# Usage: Rscript tools/download_usmca_dataweb.R
#        Rscript tools/download_usmca_dataweb.R --year 2024
#        Rscript tools/download_usmca_dataweb.R --env-file /path/to/.env
# =============================================================================
...
#' Pure parsing lives in src/io/dataweb_parser.R; this wrapper does the HTTP.
