...
Verified timeline of Chapter 99 policy changes across all 39 HTS revision points (2025 basic through 2026_rev_4). Generated from `tools/revision_changelog.R`, which diffs Ch99 entries between consecutive revisions to identify additions, removals, rate changes, and suspensions. Full diff data in `output/changelog/revision_diffs.csv`.
