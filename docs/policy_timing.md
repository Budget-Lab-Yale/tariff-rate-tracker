...
| **Quartz surface products §201 (25%/50% TRQ)** | Jul 31, 2026 (Proclamation 11051) | Aug 15, 2026 | 2026 rev_16 (published Aug 14) | **None** | Four-year safeguard to Aug 14, 2030 under U.S. note 41, headings 9903.45.30 (in-quota) / 9903.45.31 (over-quota), rates stepping down each Aug 15. HTS aligned — rev_16 published Aug 14 for an Aug 15 turn-on. Modelled at the in-quota leg (deviation S12); 124 economies exempt under note 41(c). |
| **Section 338 Canada (+50%)** | Jul 20, 2026 (PP 11046/11047/11048) | Aug 22, 2026 (12:01am ET) | 2026 rev_17 (published Aug 24) | **Synthetic boundary** | +50% on Canada over three positive HTS-8 lists (alcohol/dairy/mv, U.S. note 51, headings 9903.03.12-.14). Turn-on date moved from Aug 19 to Aug 22 by PP 11056 (operative clause amends the Annex II chapeau; the "suspension" title is a date shift, not a 3-day hole). Modeled as `bnd_2026-08-22` via `boundary_overrides`; rate read off the headings since rev_17, products still side-data from `resources/s338_products.csv` (note 51(b) is not in the JSON export). See [methodology.md](methodology.md#section-338-canada). |
| **Section 301 Brazil (25%)** | Jul 20, 2026 (Notice of Action, FR Doc 2026-14542) | Jul 22, 2026 (12:01am ET) | Not yet in checked-in HTS archive | **Synthetic boundary** | 25% on all products of Brazil except the note-50(a) lists (heading 9903.05.01, U.S. note 50). Modeled as `bnd_2026-07-22` via `boundary_overrides`, hand-fed from `policy_params.yaml` + `resources/s301_brazil_{exempt,aircraft,pharma}_products.csv` (unconditional exclusions exempt; aircraft-/pharma-use lists pay 25%×(1−share), shares 90%/50%). The one-week in-transit window (9903.05.02) is not modeled. See [methodology.md](methodology.md#section-301-brazil). |
| **Section 301 forced labor (10% / 12.5%)** | Jul 23, 2026 (USTR final action) | Jul 24, 2026 (12:01am ET) | Not yet in checked-in HTS archive | **Synthetic boundary** | Baseline current law over 60 investigated economies: flat 10%/12.5% tiers plus EU/Taiwan/Japan/Korea/Switzerland rates net of MFN, final Annex II exemptions, USMCA/FTA carve-outs, and a full Section 232 exclusion. Modeled at `bnd_2026-07-24` from `policy_params.yaml` + `resources/s301fl_final_*`. |
| **Patented-pharma §301 exclusions (FL + Brazil)** | Jul 23, 2026 (FL Annex I §B; Brazil Annex I Part B) | Jul 31, 2026 (12:01am ET) | Not in any HTS archive | **Synthetic boundary** | Patented pharmaceutical articles join the §232-scope exclusions of BOTH the forced-labor §301 (note 52(f)(8)) and Brazil §301 (note 50(a)(vi)) — two months before the pharma-§232 duty itself turns on (Sep 29). Modeled at `bnd_2026-07-31` via `patented_pharma_exempt_date` date-gates in both authorities. |
